...
// the basic animation is used in that project
class MainActivity : AppCompatActivity() {
//this animation will be work on textview
    // so textview id is textView
    // check res/anim folder where all animation is declared
